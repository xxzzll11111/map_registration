...
def main(argv):
    ...
    trans_error_curve = get_curve(trans_errors,match_confidence,match_confidence.min(),match_confidence.max(),(match_confidence.max()-match_confidence.min())/200.0)
    rot_error_curve = get_curve(rot_errors,match_confidence,match_confidence.min(),match_confidence.max(),(match_confidence.max()-match_confidence.min())/200.0)
